					...
					<div class="row">    
						...
						<tbody> 
							...
							<td>     
								<div class="media">    
									...
									<div class="media-body">              
											<a class="media-heading"  href="조태경.jsp" style="color:#444"><h5>조태경</h5></a>
											<br>
							...
							<td>     
								<div class="media">    
									<a class="pull-left">       
										<img width="80" height="100" class="media-object" src="image/서창진교수님.jpg"        
										alt="Media Object">
									</a>   
									<div class="media-body">              
											<a class="media-heading"  href="서창진.jsp" style="color:#444"><h5>서창진</h5></a>
											<br>

											 &nbsp;직위(학위):조교수(공학박사)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;연구분야:멀티미디어 원격시스템<p>
											 &nbsp;사무실:한누리관 601B 호&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전화번호:041-550-5445<p>
									</div> 
								</div> 
							</td>
							</tr>
							...
							<td>     
								<div class="media">    
									<a class="pull-left">       
										<img width="80" height="100" class="media-object" src="image/이광재교수님.png"        
										alt="Media Object">
									</a>   
									<div class="media-body">              
											<a class="media-heading"  href="이광재.jsp" style="color:#444"><h5>이광재</h5></a>
											<br>

											 &nbsp;직위(학위):조교수(공학박사)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;연구분야:마이크로시스템<p>
											 &nbsp;사무실:한누리관 601C 호&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전화번호:041-550-5269<p>
									</div> 
								</div> 
							</td>
							</tr>
							...
							<td>     
								<div class="media">    
									<a class="pull-left">       
										<img width="80" height="100" class="media-object" src="image/김제국교수님.jpg"        
										alt="Media Object">
									</a>   
									<div class="media-body">              
											<a class="media-heading"  href="김제국.jsp" style="color:#444"><h5>김제국</h5></a>
											<br>

											 &nbsp;직위(학위):조교수(공학박사)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;연구분야:IT정책/보안<p>
											 &nbsp;사무실:한누리관 507A 호&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;전화번호:041-550-5242<p>
									</div> 
								</div> 
							</td>
							</tr>
							...
							<td>     
								<div class="media">    
									...
									<div class="media-body">              
											<a class="media-heading"  href="국중진.jsp" style="color:#444"><h5>국중진</h5></a>
											<br>
							...
							<td>     
								<div class="media">    
									...
									<div class="media-body">              
											<a class="media-heading"  href="이성우.jsp" style="color:#444"><h5>이성우</h5></a>
											<br>
