			...
			<div class="panel panel-default">    
				...
				<div class="panel-body">	
					...
					%>
						...
						<form method="post" action="앨범_UpdateAction.jsp?albumId=<%=albumId%>">
						<table class="table">
							<tbody>
								<%
				                ...
				                <tr>
				                    <td><textarea type="text"  class="form-control" name="albumText" maxlength="200" style="height:200px;"><%= list.getAlbumText() %></textarea></td>
				                </tr>
				                <tr>
				                ...
				                <tr>
				                    <td><input type="file" name="albumFileName" size="50"/></td>
				                </tr>
				                <tr>
				                    <td colspan="2">
