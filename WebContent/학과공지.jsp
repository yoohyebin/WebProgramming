...
<div class="center-block" style="width:900px;">
	<div class="clearfix" > 
		...
		<table class="table table-hover">
			...
			<tbody>
				<%
					...
					ArrayList<Notice> list = qDAO.getList(pageNumber);
					for(int i=0; i< list.size(); i++){
					
				%>
				<tr>
					<td><%= list.get(i).getNoticeID() %></td>
					<td><a href="학과공지_view.jsp?noticeID=<%=list.get(i).getNoticeID()%>" style="color:#444"><%=list.get(i).getNoticeTitle()%></a></td>
					<td><%= list.get(i).getNoticeUserID() %></td>
		...
		<a href="학과공지_write.jsp" class="btn btn-primary pull-right">글쓰기</a>
		<br>
		<br>
		<br>
		<center>
		<form method="post" action="학과공지_search.jsp">
		<table>
		<tr>
			<td>
