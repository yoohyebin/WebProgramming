	...
	<div class="clearfix" > 
		...
		<div class="row">    	   	
			...
			<div class="panel panel-default">    
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						for(int i=0; i< list.size(); i++){
							...
							{
							if(request.getParameter("search").equals(list.get(i).getNoticeUserID())){
						%>
						<tr>
						...
						<%
							...
							{
								if(request.getParameter("search").equals(list.get(i).getNoticeTitle()))
								{
						%>
						<tr>
							<td><%= list.get(i).getNoticeID() %></td>
				...
				<a href="학과공지.jsp" class="btn btn-primary pull-right">목록</a>
			</div>
		</div>
	</div>
</div>
