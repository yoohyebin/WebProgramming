			...
			<div class="panel panel-default">    
				...
				<div class="panel-body">
			      ...
			      <div class="center-block" style="width:600px;">
			      	<form method="post" action="q&a_updateAction.jsp?queID=<%=queID%>">
						<table class="table">
							<tbody>
							<%
								Que list = nDAO.getQue(queID);
							%>
							<tr>
								<td><td><textarea type="text"  class="form-control" name="queTitle" maxlength="200" style="height:200px;"><%= list.getQueTitle() %></textarea></td></td>
							</tr>
							<tr>
								<td><td><textarea type="text"  class="form-control" name="queContent" maxlength="200" style="height:200px;"><%= list.getQueContent() %></textarea></td></td>
							</tr>
							</tbody>
						</table>
