		...
		<div class="row">    	
			...
			<div class="panel panel-default">    
				...
				<div class="panel-body"> 
						...
						<a href="update.jsp?queID=<%=que.getQueID()%>" class="btn btn-primary">수정</a>
						...
						<%
							...
							Re list = reDAO.getRe(reID);
						%>
						<form action="q&a_reupdateAction.jsp?reID=<%=reID %>" method="post" >
							<div>
								<textarea type="text"  class="form-control" name="reText" maxlength="100" style="height:120px;"><%=list.getReText() %></textarea>
								<br>
								<input type="submit" class="btn btn-primary pull-right" value="저장">
								<a href="q&a_view.jsp" class="btn btn-primary">목록</a>
							</div>
						</form>
					</div>
			</div>
