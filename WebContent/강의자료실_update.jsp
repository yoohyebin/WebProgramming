		...
		<div class="row">    	
			...
			<div class="panel panel-default">    
				...
				<div class="panel-body">  
					...
					%>
					<form method="post" action="강의자료실_updateAction.jsp?bbsID=<%=bbsID %>">
						<tbody>
						<%
						...
						%>
							...
							<tr>
								<td><textarea type="text"  class="form-control" name="bbsTitle" maxlength="200" style="height:40px;"><%=list.getBbsTitle() %></textarea></td>
							</tr>
							<tr>
								<td>내용</td>
							</tr>
							<tr>
								<td><textarea type="text"  class="form-control" name="bbsContent" maxlength="200" style="height:200px;"><%=list.getBbsContent() %></textarea></td>
							</tr>
							<tr>
								<td>첨부파일</td>
							</tr>
							<tr>
								<td><input type="file" name="bbsFileName" size="50"/><%=list.getBbsFileName() %></td>
							</tr>
							<br>
							<br>
							<tr>
