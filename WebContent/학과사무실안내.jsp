...
<br>
<div class="center-block" style="width:940px;">
	<div class="clearfix" > 
		<div class="pull-left">
		...
		<div class="row">    	
			...
			<div class="panel panel-default">    
				...
				<ul>   
					<li>학과사무실 안내 : 한누리관(I 동) 6층  602 호</li>   
					<li>운영시간 : 09:00  ~ 12:00,  13:00  ~ 17:00 (평일)</li>   
					<li>전화번호 : 041-550-5205</li>   
					<li>팩      스  : 041-550-5208</li>
					<li>학과주소 : (우) 31066 충남 천안시 동남구 상명대길 31 한누리관 602 호 정보보안공학과 </li> 
				</ul>
				<br>
				<center>                
					<img src="image/과사.jpg" alt="Cinque Terre">          
				</center>   
				</div> 
			</div>
			</div> 
