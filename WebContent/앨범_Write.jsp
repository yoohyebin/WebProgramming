...
<title>Image File Upload to Database</title>
</head>
<body>
<center>
...
<div class="clearfix" > 
	<div class="pull-left">
		...
		<div class="row">    	
			<div class="center-block" style="width:630px;"> 
			<div class="panel panel-default">    
				...
				<div class="panel-body">
        			<form method="post" action="앨범_WriteAction.jsp">
			            <table class="table">
			                <tr>
			                    <td>이미지 설명  </td>
			                    <td><textarea type="text"  class="form-control" placeholder="글 내용" name="albumText" maxlength="100" style="height:150px;"></textarea></td>
			                </tr>
			                <tr>
			                    <td>첨부파일</td>
