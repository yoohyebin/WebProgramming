			...
			<div class="panel panel-default">    
				...
				<div class="panel-body">       
					...
					%>
						...
						<center>       
							<div class="thumbnail" style="width:120px; height:80px;">         
								<a href="앨범_View.jsp?albumId=<%=list.get(i).getAlbumId()%>" > <img src="앨범_Read.jsp?albumId=<%=list.get(i).getAlbumId()%>" style="width:110px; height:70px;" onerror="this.src='no_img.jpg'" class="flot-left" > </a>      
							</div>       
							<div class="caption">         
								<a href="앨범_View.jsp?albumId=<%=list.get(i).getAlbumId()%>"> <%= list.get(i).getAlbumText() %> </a>        
							</div> 
							</center>   
						</div> 
					<%
					...
					<div class="clearfix" style="width:620px;">
						<a href="앨범_Write.jsp" class="btn btn-primary pull-right">이미지 올리기</a>
					</div>
				</div> 
			</div>
			</div> 
