			...
			<div class="panel panel-default">    
				...
				<div class="panel-body">
			      <div class="center-block" style="width:600px;">
			      	<form action="q&a_writeAction.jsp" method="post" >
			      	<hr>
						<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
							<tbody>
								<tr>
									<td><input type="text" class="form-control" placeholder="글 제목" name="queTitle" maxlength="50"></td>
								</tr>
								<tr>
									<td><textarea type="text"  class="form-control" placeholder="글 내용" name="queContent" maxlength="2048" style="height:350px;"></textarea></td>
								</tr>
							</tbody>
						</table>
