			...
			<div class="panel panel-default">    
				...
				<div class="panel-body">
			      ...
			      <div class="center-block" style="width:600px;">
			      	<form method="post" action="학과공지_updateAction.jsp?noticeID=<%=noticeID%>">
						<table class="table">
							<tbody>
							<%
								Notice list = nDAO.getNotice(noticeID);
							%>
							<tr>
								<td><td><textarea type="text"  class="form-control" name="noticeTitle" maxlength="200" style="height:200px;"><%= list.getNoticeTitle() %></textarea></td></td>
							</tr>
							<tr>
								<td><td><textarea type="text"  class="form-control" name="noticeContent" maxlength="200" style="height:200px;"><%= list.getNoticeContent() %></textarea></td></td>
							</tr>
							</tbody>
						</table>
