	...
	<div class="clearfix" > 
		...
		<div class="row">    	
			...
			<div class="panel panel-default">    
				...
				<table class="table table-hover">
					...
					<tbody>
						...
						for(int i=0; i< list.size(); i++){
							...
							{
							if(request.getParameter("search").equals(list.get(i).getQueUserID())){
						%>
						<tr>
						...
						<%
							...
							{
								if(request.getParameter("search").equals(list.get(i).getQueTitle()))
								{
						%>
						<tr>
							<td><%= list.get(i).getQueID() %></td>
				...
				<a href="q&a.jsp" class="btn btn-primary pull-right">목록</a>
			</div>
	     </div>
 	</div>
 	</div>
